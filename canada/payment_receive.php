...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            value="<?php echo htmlspecialchars($_POST['subject'] ?? 'YOUR PAYMENT WAS SUCCESSFUL - APPLICATION PROCESSING HAS STARTED'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 24)  ? 'selected' : ''; ?>>
