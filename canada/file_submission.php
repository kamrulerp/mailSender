...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="config_id" name="config_id" required>
                                                    <option value="10">Canada (noreply@ca.legalimmigrate.com)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
         ...
         value="<?php echo htmlspecialchars($_POST['subject'] ?? 'ACKNOWLEDGMENT OF WORK PERMIT APPLICATION'); ?>" required>
                                    </div>
                    ...
                    <select class="form-control" id="template_id" name="template_id">
                        ...
                        <?php foreach ($templates as $template): ?>
                            <option value="<?php echo $template['id']; ?>" <?php echo ((!isset($_POST['template_id']) && $template['id'] == 23) || (isset($_POST['template_id']) && $_POST['template_id'] == $template['id'])) ? 'selected' : ''; ?>>
