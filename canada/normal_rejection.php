...
<div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      value="<?php echo htmlspecialchars($_POST['subject'] ?? 'REFUSAL ACKNOWLEDGEMENT NOTIFICATION'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 28)  ? 'selected' : ''; ?>>
