                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="<?php echo htmlspecialchars($_POST['subject'] ?? 'DECISION ON YOUR APPLICATION FOR A WORK PERMIT IN CANADA'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 29)  ? 'selected' : ''; ?>>
