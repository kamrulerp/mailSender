    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                value="<?php echo htmlspecialchars($_POST['subject'] ?? 'SUBMISSION OF REQUIRED DOCUMENTS FOR LOW-SKILLED WORK PERMIT APPLICATION'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 26)  ? 'selected' : ''; ?>>
