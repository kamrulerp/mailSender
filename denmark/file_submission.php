                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="config_id" name="config_id" required>
                                                    <option value="9">Denmark (noreply@dk.legalimmigrate.com)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" id="subject" name="subject"  value="<?php echo htmlspecialchars($_POST['subject'] ?? 'ACKNOWLEDGMENT OF WORK VISA APPLICATION FOR DENMARK'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ((!isset($_POST['template_id']) && $template['id'] == 19) || (isset($_POST['template_id']) && $_POST['template_id'] == $template['id'])) ? 'selected' : ''; ?>>
