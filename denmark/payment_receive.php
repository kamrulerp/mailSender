                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" id="subject" name="subject"  value="<?php echo htmlspecialchars($_POST['subject'] ?? 'PAYMENT CONFIRMATION AND FOLLOW-UP ON YOUR DENMARK WORK PERMIT VISA APPLICATION'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 20)  ? 'selected' : ''; ?>>
