...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($config_name)) {
        ...
        $result = $emailConfig->updateConfig(
            $config_id, $config_name, $email, $from_name, $smtp_host, $smtp_port,
            $smtp_username, $smtp_password, $smtp_encryption, $description, $status
        );
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    Edit Configuration: <?php echo htmlspecialchars($config['config_name']); ?>
                                </h3>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="card bg-light">
                                                <div class="card-body">
                                                    <h6 class="card-title">Configuration Information</h6>
                                                    <p class="card-text">
                                                        <strong>Created at:</strong> <?php echo date('M d, Y H:i A', strtotime($config['created_at'])); ?><br>
                                                        <?php if ($config['updated_at']): ?>
                                                            <strong>Last updated:</strong> <?php echo date('M d, Y H:i A', strtotime($config['updated_at'])); ?>
                                                        <?php endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <input type="text" class="form-control" id="config_name" name="config_name" value="<?php echo htmlspecialchars($config['config_name']); ?>" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="from_name" name="from_name" value="<?php echo htmlspecialchars($config['from_name']); ?>" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="smtp_host" name="smtp_host" value="<?php echo htmlspecialchars($config['smtp_host']); ?>" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="smtp_port" name="smtp_port" value="<?php echo $config['smtp_port']; ?>" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="smtp_username" name="smtp_username" value="<?php echo htmlspecialchars($config['smtp_username']); ?>" required>
                            ...
                            <div class="card-body">
                                <table class="table table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $config['smtp_encryption'] ? strtoupper($config['smtp_encryption']) : 'None'; ?></td>
                                    </tr>
                                    <tr>
...
function testConnection() {
    const formData = {
        ...
        smtp_password: $('#smtp_password').val() || '<?php echo $config['smtp_password']; ?>',
