                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="config_id" name="config_id" required>
                                                    <option value="6">Austrailia (mailsender@techtune.cloud)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" id="subject" name="subject"  value="<?php echo htmlspecialchars($_POST['subject'] ?? 'YOUR PAYMENT WAS SUCCESSFUL - APPLICATION PROCESSING HAS STARTED'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 7)  ? 'selected' : ''; ?>>
