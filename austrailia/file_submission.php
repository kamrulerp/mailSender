                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="subject" name="subject"  value="<?php echo htmlspecialchars($_POST['subject'] ?? 'ACKNOWLEDGEMENT FOR APPLICATION SUBMITTED'); ?>" required>
                                    </div>
