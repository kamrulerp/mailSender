                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="<?php echo htmlspecialchars($_POST['subject'] ?? 'PAYMENT CONFIRMATION - IRELAND WORK VISA APPLICATION'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ($template['id'] == 31)  ? 'selected' : ''; ?>>
