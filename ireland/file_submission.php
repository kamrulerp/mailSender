                            ...
                            <form method="post" action="">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="config_id" name="config_id" required>
                                                    <option value="11">Ireland (noreply@ie.legalimmigrate.com)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="<?php echo htmlspecialchars($_POST['subject'] ?? 'ELIGIBLE ACKNOWLEDGEMENT FOR IRELAND WORK PERMIT VISA APPLICATION'); ?>" required>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="template_id" name="template_id">
                                                    ...
                                                    <?php foreach ($templates as $template): ?>
                                                        <option value="<?php echo $template['id']; ?>" <?php echo ((!isset($_POST['template_id']) && $template['id'] == 30) || (isset($_POST['template_id']) && $_POST['template_id'] == $template['id'])) ? 'selected' : ''; ?>>
